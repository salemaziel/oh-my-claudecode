...
- Watch the [GitHub repository](https://github.com/salemaziel/oh-my-claudecode) for announcements
...
- **Report bugs**: [GitHub Issues](https://github.com/salemaziel/oh-my-claudecode/issues)
