...
```
WebFetch(url: "https://raw.githubusercontent.com/salemaziel/oh-my-claudecode/main/docs/CLAUDE.md", prompt: "Return the complete raw markdown content exactly as-is")
```
