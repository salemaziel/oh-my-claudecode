...
```bash
gh api user/starred/salemaziel/oh-my-claudecode &>/dev/null
```
...
```bash
gh api -X PUT /user/starred/salemaziel/oh-my-claudecode 2>/dev/null && echo "Thanks for starring!" || true
```
...
echo "  https://github.com/salemaziel/oh-my-claudecode"
echo ""
```
