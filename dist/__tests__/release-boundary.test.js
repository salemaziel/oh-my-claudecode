...
const { assertArchive, assertEvidence, assertNpmAbsent, assertSlsaProvenance, assertSigstoreFallback, assertTrigger, buildEvidenceFromBytes, classifySigstoreRekorFailure, cliMain, decodeDssePayload, prepareStage, selectSlsaAttestation, verifyRegistry, writeEvidence, } = releaseBoundary;
