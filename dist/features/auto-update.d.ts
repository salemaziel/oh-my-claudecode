...
export declare const REPO_OWNER = "salemaziel";
export declare const REPO_NAME = "oh-my-claudecode";
export declare const GITHUB_API_URL = "https://api.github.com/repos/salemaziel/oh-my-claudecode";
export declare const GITHUB_RAW_URL = "https://raw.githubusercontent.com/salemaziel/oh-my-claudecode";
