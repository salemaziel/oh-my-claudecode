...
describe('runtime owner epochs', () => {
    ...
    it('derives subsecond process-start identities from native macOS sysctl and exact Windows ticks', () => {
        ...
        expect(exec).toHaveBeenCalledWith('/usr/sbin/sysctl', ['-b', 'kern.proc.pid.42'], { encoding: null, maxBuffer: 1024 * 1024 });
        ...
        const missingNativeHelper = vi.fn(() => { throw new Error('sysctl missing'); });
