...
1. **Fork the repository** on GitHub by clicking the "Fork" button at https://github.com/salemaziel/oh-my-claudecode
...
3. **Add the upstream remote** so you can sync with the main repository:
   ```bash
   git remote add upstream https://github.com/salemaziel/oh-my-claudecode.git
   ```
...
4. **Verify your remotes**:
   ...
   # upstream  https://github.com/salemaziel/oh-my-claudecode.git (fetch)
   # upstream  https://github.com/salemaziel/oh-my-claudecode.git (read-only)
   ```
...
2. **Open a PR** on GitHub:
   - Go to https://github.com/salemaziel/oh-my-claudecode/pulls
...
- **GitHub Issues**: https://github.com/salemaziel/oh-my-claudecode/issues
